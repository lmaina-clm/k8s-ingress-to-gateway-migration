[English](09-fast-validation-runbook.md) | **Español**
...
> **No es** un sustituto del runbook de producción ([04-migration-runbook.es.md](./04-migration-runbook.es.md)). Es la versión "smoke test" para ver el patrón funcionando end-to-end antes de aplicarlo en un cluster real.
